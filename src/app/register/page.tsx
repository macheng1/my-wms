...
import { Form, Button, Card, Typography, Toast, Select, Divider } from '@douyinfe/semi-ui-19';
import { 
  IconUser, IconLock, IconHome, IconBriefcase, 
  IconArrowLeft, IconPhone, IconIdCard 
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4 relative overflow-hidden">
      ...
      <Card
        ...
        style={{ borderRadius: '16px', backgroundColor: 'rgba(255, 255, 255, 0.98)' }}
      ...
      >
        ...
        <div className="mb-8">
          <Title heading={3} style={{ fontWeight: 700 }}>新工厂/租户入驻</Title>
          <Text type="tertiary">请完善企业及管理员信息以开通 WMS 智能仓储服务</Text>
        </div>
        ...
        <Form onSubmit={handleSubmit} labelPosition="top">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Form.Select
              ...
              style={{ width: '100%' }}
            >
              <Select.Option value="heating_element">电热元件制造</Select.Option>
